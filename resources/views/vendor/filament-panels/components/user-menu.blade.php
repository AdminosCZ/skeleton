    ...
    <x-slot name="trigger">
        @if ($position === UserMenuPosition::Topbar)
            <button
                ...
                type="button"
                class="fi-user-menu-trigger adminos-user-menu-trigger"
            >
                <x-filament-panels::avatar.user :user="$user" loading="lazy" />

                <span class="adminos-user-display">
                    <span class="adminos-user-display__name">
                        {{ filament()->getUserName($user) }}
                    </span>
                    @if (isset($user->role) && $user->role)
                        <span class="adminos-user-display__role">
                            {{ $user->role->label() }}
                        </span>
                    @endif
                </span>
